...
@export var equip_arm : arm_equip = preload("res://src/arm_equip.gd").new()
@export var equip_body : body_equip = preload("res://src/body_equip.gd").new()
@export var equip_leg : leg_equip = preload("res://src/leg_equip.gd").new()

@export var equip_scroll_a : scroll_equip = preload("res://src/scroll_equip.gd").new()
@export var equip_scroll_b : scroll_equip = preload("res://src/scroll_equip.gd").new()
